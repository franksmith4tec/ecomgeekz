        ...
        <div class="row">
            <div class="col-lg-8 text-center offset-lg-2">
                <div class="txtwrp">
                    ...
                    <p>At EcomGeekz, we specialize in launching and scaling marketing agencies with precision and excellence. Our unbeatable approach combines data-driven insights with personalized strategies to ensure your agency reaches monthly revenues of up to $10,000.</p>
                </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-8 text-center offset-lg-2 mt-3">
                <div class="txtwrp">
                    <p>We guide you through every step, leveraging industry expertise and continuous optimization to unlock your business's full potential. With EcomGeekz, you benefit from tailored solutions that align with your unique goals and audience, and our ongoing support ensures long-term success and growth. Trust EcomGeekz to turn your vision into a thriving, profitable agency.</p>
                    <a href="at-appointment.php" class="themes-btn">SCHEDULE A FREE CONSULTATION</a>
                </div>
            </div>
            </div>
    ...
    <div class="container">
        <div class="row testament">
           <div class="col-lg-6 my-auto">
               <h2 class="">Launch your marketing agency with EcomGeekz</h2>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 offset-lg-1">
                <h2>How EcomGeekz makes iIt happen.</h2>
                <p>EcomGeekz is dedicated to delivering a revolutionary online business program, setting new industry standards. Our goal is to nurture and empower the next generation of agencies. </p>
                <p>We challenge outdated business strategies and aim to boost your income by at least threefold. You don't need prior industry experience; EcomGeekz's proven formula helps beginners start and grow their agencies profitably. We also empower 6-figure agencies to scale into 7-figures.</p>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
                    ...
                    <p>We help you establish your marketing agency by forming your company and ensuring all legal and administrative details are covered. With EcomGeekz's guidance, you'll lay a solid foundation for long-term success and compliance.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
                    ...
                    <p>We set up all necessary digital assets, including websites, social media profiles, and branding materials. EcomGeekz ensures your online presence is professional and engaging, helping you attract and retain clients.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
                    ...
                    <p>We provide comprehensive onboarding and training for your team, ensuring everyone is aligned with your agency's goals and processes. With EcomGeekz, your team will be equipped with the skills and knowledge needed to drive your agency forward.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
                    ...
                    <h3>Accelerate your growth</h3>
                    <p>EcomGeekz helps you implement strategies for sustained revenue growth and scalability. From lead generation to client retention, we ensure your agency not only survives but thrives in a competitive market.</p>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingfive">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
       How does EcomGeekz ensure a smooth transition from setup to recurring revenue?
      </button>
    </h2>
   ...
   <div class="accordion-item">
    <h2 class="accordion-header" id="headingfive">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
       How does EcomGeekz handle data privacy and confidentiality?
      </button>
    </h2>
    <div id="collapsefive" class="accordion-collapse collapse" aria-labelledby="headingfive" data-bs-parent="#accordionExample">
      <div class="accordion-body">
