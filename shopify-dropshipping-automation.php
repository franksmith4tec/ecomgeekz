        ...
        <div class="row">
            <div class="col-lg-6">
                <ul class="list-page">
                    ...
                    <li><a href="shopify-dropshipping-automation.php" class="active">Shopify Dropshipping Automation</a></li>
                </ul>
                ...
                <h6><b>EcomGeekz will create and set up a fully optimized Shopify dropshipping store for you, featuring top-selling products, trusted suppliers, and a conversion-focused design, all backed by dedicated support.</b></h6>
    ...
    <div class="container">
        <div class="row testament">
           <div class="col-lg-6">
               ...
               <a href="javascript:(void)" class="themes-btn mt-3" data-bs-toggle="modal" data-bs-target="#infoModal">Ready to launch shopify dropshipping with EcomGeekz</a>
           </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 offset-lg-1">
                <h2>EcomGeekz Drives Profitable Revenue with Recession-Proof Expertise</h2>
                <p>EcomGeekz, an eCommerce success management firm, works closely with clients to build recession-proof Shopify businesses. With our extensive experience, we ensure your store thrives in any economic environment.</p>
                ...
                <h2>EcomGeekz: Streamline and Scale Your Shopify Dropshipping Business
...
<section class="important-sec padd-tb">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h2>Benefits of launching shopify dropshipping automation with EcomGeekz
                </h2>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-6">
                <a href="javascript:(void)" class="themes-btn" data-bs-toggle="modal" data-bs-target="#infoModal">Ready to launch shopify dropshipping with EcomGeekz</a>
            </div>
        </div>
    </div>
</section>
...
<section class="faq-sec padd-tb">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingfour">
      ...
      What Sets EcomGeekz's Shopify Dropshipping Automation Apart from Others?
      </button>
    </h2>
    <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
      <div class="accordion-body">
       <p>EcomGeekz offers a complete Shopify Dropshipping Automation service, covering everything from product research and store setup to marketing strategies and order management. We prioritize high-quality service, quick customer support, and a strong commitment to your success.</p>
      </div>
    </div>
  </div>
