...
<section class="banner-main-sec">
    <img src="assets/images/ecom-Main-Banner.jpg" class="banne-img" alt="img" />
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <ul class="list-page">
                    ...
                    <li><a href="start-your-ecommerce-brand.php" class="active">Start Ecommerce Brand</a></li>
                </ul>
    ...
    <div class="container">
        <div class="row testament">
           ...
           <div class="col-lg-5 offset-lg-1 my-auto">
               <div class="imgwrp">
                <img src="assets/images/ecom-First-Fold.jpg" alt="img" />
...
<section class="means-sec style padd-tb">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <div class="imgwrp">
                <img src="assets/images/ecom-Second-Fold.jpg" alt="img" />
                  <div class="upper first image-lable">
                    <div class="txtwrp">
                      <p>Achieved Best Seller status in your category!</p>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                ...
                <!--      <input type="hidden" id="location" name="locationURL" value="http://ecomgeekz.com/start-your-ecommerce-brand" />-->
                <!--        </div>-->
                <!--    </div>-->
                <!--</form>-->
            </div>
