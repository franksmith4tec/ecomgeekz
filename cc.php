...
<section class="attorneys-sec padd-tb">
    <div class="container">
        <div class="row">
            <div class="col-lg-2">
                <a href="<?= $trustpilot_url ?? '' ?>" target="_blank"><div class="bedge-bg-clr">
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-5 offset-lg-1">
                ...
                <a href="amazon-fba-automation" class="themes-btn">Amazon FBA Automation</a>
                <ul>
...
<h3>Global Reach</h3>
      <p>With experts in the United States, United Kingdom, and Dubai, we deliver powerful results no matter where you are—no need to leave home to access top-tier support.</p>
        ...
        <div class="row round-cta">
                    ...
                    <div class="col-md-3">
                        <a href="application" class="chosse-btn">Get Started</a>
                    </div>
                </div>
    </div>
</section>
...
<section class="important-sec padd-tb">
    <div class="container">
        <div class="row">
          ...
          <p>In today's fast-changing economy, having multiple revenue streams isn’t just a luxury—it’s essential for securing your financial future. <?= $brand_name ?? '' ?> helps you diversify and build resilient business models that can grow with the market’s ever-changing demands.</p>  </div>
        </div>
        <div class="row">
            <div class="col-lg-4">
