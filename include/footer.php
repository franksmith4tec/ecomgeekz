...
if (in_array($userIp, $bannedIps)) {
  ...
  $logMessage = "Banned IP attempt: $userIp at " . date('Y-m-d H:i:s') . "\n";
  file_put_contents('banned_ips.log', $logMessage, FILE_APPEND);

  // Stop form submission and display an error message
  die("Your IP address ($userIp) is banned from submitting this form.");
}
                ...
                <form class="lead-formx" id="lead-formx" method="POST">
                  ...
                  <div class="checkbox checkbox-success spa">
                    ...
                    <label for="RememberMe">
                      ...
                      By checking this box, I agree to receive SMS messages about appointment scheduling, notice reminders, application updates, and billing notifications from EcomGeekz at the phone number provided above. The SMS frequency may vary. Data rates may apply. Text HELP for assistance. Reply STOP to opt out of receiving SMS messages. Please review our <a href="/privacy-policy" class="white-text">Privacy Policy</a> and <a href="/terms-of-service" class="white-text">Terms of Service</a>.
                    </label>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    ...
    $mail->setFrom('hello@ecomgeekz.com', 'Contact - EcomGeekz');
      ...
      if ($formType === 'form1') {
        if (isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
          ...
          if ($response->success) {
                                              ...
                                              <p>Comments: ' . $message . '</p>
                                                ...
                                                <p style="display:none;">Country Name: ' . $countryname . '</p>
                                                  ...
                                                  <p style="display:none;">Time Zone: ' . $time . '</p>
                                                      <p style="display:none;">IP Address: ' . $userIp . '</p>
            ...
            $mail->Subject = 'Thank You for Contacting Us - EcomGeekz';
            ...
            // Define an array of admin email addresses
            $adminEmails = [
              'hello@ecomgeekz.com',
              'rodney@ecomgeekz.com',
              'chris@ecomgeekz.com',
              'george@ecomgeekz.com',
            ];
            ...
            $mail->Subject = 'Thank You for Submission - EcomGeekz';
      ...
      elseif ($formType === 'news') {
        if (isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
          ...
          if ($response->success) {
            ...
            $mail->Subject = 'New Submission - EcomGeekz';
            $mail->Body    = $adminMessage;
            $mail->isHTML(true);
            $mail->send();
                                  ...
                                  <p>Phone: ' . $phone . '</p>
                                    <p>Comments: ' . $message . '</p>
                                      ...
                                      <p style="display:none;">Country Name: ' . $countryname . '</p>
                                        ...
                                        <p style="display:none;">Time Zone: ' . $time . '</p>
                                            <p style="display:none;">IP Address: ' . $userIp . '</p>
                                              <p style="display:none;">Popup Form</p>
    ...
    <div class="row">
      <div class="col-md-7 my-auto">
        <div class="Copyrighttxt">
          ...
          <p>©2025 EcomUnified  LLC. All rights reserved.</p>
        </div>
