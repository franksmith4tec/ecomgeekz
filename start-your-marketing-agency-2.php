        ...
        <div class="row">
            <div class="col-lg-6">
                <ul class="list-page">
                    ...
                    <li><a href="start-your-marketing-agency.php" class="active">Start Marketing Agency</a></li>
                </ul>
    ...
    <div class="container">
        <div class="row testament">
           ...
           <div class="col-lg-5 offset-lg-1 my-auto">
               <div class="imgwrp">
                <img src="assets/images/marketing-First-Fold.jpg" alt="img" />
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                ...
                <!--      <input type="hidden" id="location" name="locationURL" value="http://ecomgeekz.com/start-your-marketing-agency.php" />-->
                <!--        </div>-->
                <!--    </div>-->
                <!--</form>-->
            </div>
