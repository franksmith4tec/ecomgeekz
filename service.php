...
<section class="banner-main-sec">
    <img src="assets/images/service-banner-img.webp" class="banne-img" alt="img" />
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <ul class="list-page">
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="register-box">
                    ...
                    <h2 class="gradient-heading">Amazon FBA automation</h2>
                    <h3>Effortlessly scale your business with automated Amazon FBA solutions.</h3>
                    <p>Our Amazon FBA Automation service streamlines your e-commerce operations, managing inventory, fulfillment, and customer service, allowing you to effortlessly scale your business and maximize profits with minimal effort.</p>
                </div>
              </div>
              ...
              <div class="col-lg-4">
                <div class="register-box">
                    ...
                    <h2 class="gradient-heading">Dropshipping shopify automation</h2>
                    <h3>Simplify your e-commerce success with automated Shopify dropshipping.</h3>
                    <p>Explore the world of drop shipping with expert consultancy. Get assistance with product sourcing, store setup, and effective marketing strategies to excel in the e-commerce landscape.</p>
                </div>
                </div>
              ...
              <div class="col-lg-4">
                <div class="register-box">
                    ...
                    <h2 class="gradient-heading">Start ecommerce brand</h2>
                    <h3>Launch and grow your unique e-commerce brand with expert guidance.</h3>
                    <p>Embark on a journey of e-commerce entrepreneurship. Our guidance empowers you to build, brand, and profit from your online store, turning your vision into a thriving e-commerce brand.</p>
                </div>
                </div>
              ...
              <div class="col-lg-4">
                <div class="register-box">
                    ...
                    <h2 class="gradient-heading">Personal branding</h2>
                    <h3>Build a powerful personal brand and become a leader in your niche.</h3>
                    <p>Unlock your potential as a consultant or coach. Develop your unique personal brand with our guidance, and gain the tools to impact lives while growing a successful consultancy or coaching business.</p>
                </div>
                </div>
              ...
              <div class="col-lg-4">
                <div class="register-box">
                    ...
                    <h2 class="gradient-heading">Youtube automation</h2>
                    <h3>Maximize your YouTube revenue with automated content creation and monetization.</h3>
                    <p>Embark on a journey to automate and grow on YouTube. Our expert guidance covers content strategy, audience engagement, and monetization, empowering you to succeed in the dynamic world of online video.</p>
                </div>
                </div>
              <div class="col-lg-4">
                <div class="register-box">
                    <img src="assets/images/EcomGeekz-services-mobile-application.svg" alt="img" />
                    <h2 class="gradient-heading">Launch mobile application</h2>
                    <h3>Develop revenue-generating mobile apps to expand your business.</h3>
                    <p>Unlock a profitable revenue stream through mobile apps. & turn your app idea into reality. Our comprehensive program covers app development, design, and launch strategies, equipping you to capitalize on the lucrative app market.</p>
                </div>
                </div>
              <div class="col-lg-4">
                <div class="register-box">
                    <img src="assets/images/EcomGeekz-services-marketing-agency.svg" alt="img" />
                    <h2 class="gradient-heading">Start marketing agency</h2>
                    <h3>Establish and scale a profitable marketing agency with proven strategies.</h3>
                    <p>Ready to dive into the dynamic world of marketing? Our comprehensive program equips you with the skills and strategies to launch your very own successful marketing agency.</p>
                </div>
                </div>
              <div class="col-lg-4">
                <div class="register-box">
                    <img src="assets/images/EcomGeekz-services-revenue-streams.svg" alt="img" />
                    <h2 class="gradient-heading">Create revenue streams</h2>
                    <h3>Diversify your income with multiple, sustainable revenue streams.</h3>
                    <p>Expand your financial horizons with diverse income streams. Our program explores various revenue generation methods, helping you secure your financial future with multiple income sources.</p>
                </div>
                </div>
                <div class="col-lg-4">
                <div class="register-box">
                    <img src="assets/images/EcomGeekz-services-kickstart.svg" alt="img" />
                    <h2 class="gradient-heading">Kickstarter campaign</h2>
                    <h3>Drive your project's success with a strategic, impactful Kickstarter campaign.</h3>
                    <p>Launch successful Kickstarter campaigns with our expert guidance. We'll help you plan, execute, and fund your innovative ideas, turning your dreams into reality with effective crowdfunding strategies.</p>
                </div>
                </div>
...
<!-- affordable-sec -->
<section class="affordable-sec padd-tb">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="trade-box">
                    ...
                    <div>
                        <img src="assets/images/attorney-profile.webp" alt="img" />
                    </div>
                    </div>
                    <hr>
                    <p>Striving for longterm success: Discover strategies to not only achieve success but also sustain it in the ever-changing business landscape.</p>
                    <ul>
    ...
    <div class="container">
        ...
        <div class="row mt-3">
            <div class="col-lg-4">
                <div class="tell-box">
                <span>1</span>
                <h2 class="gradient-heading">Consult</h2>
                <h3>Personalized expert guidance</h3>
                <p>Receive personalized 1-on-1 digital consultancy, leveraging expert insights to shape your business vision and strategies.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="tell-box">
                <span>2</span>
                <h2 class="gradient-heading">Strategize</h2>
                <h3>Plan for success</h3>
                <p>Craft a robust business strategy with the guidance of an experienced consultant, ensuring a clear path to entrepreneurial success.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="tell-box">
                <span>3</span>
                <h2 class="gradient-heading">Execute</h2>
                <h3>Bring your vision to life</h3>
                <p>Implement your business plans confidently, supported by our consultant, resources, and a community of fellow entrepreneurs, bringing your vision to life.</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- means-sec -->
<section class="means-sec style padd-tb bg-fill">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
...
<!-- different-sec -->
<section class="different-sec padd-tb">
    <div class="container">
        <div class="row mg-120">
            <div class="col-lg-6 my-auto">
                ...
                <!--    <li><span>3</span> <p>The goods or services that you want to offer through your name</p></li>-->
...
<!-- different-sec -->
<section class="common-sec padd-tb bg-fill">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
            ...
            <div class="col-lg-6 offset-lg-1">
               ...
               <ul class="bottol-list list-numb">
                   ...
                   <li>The goods or services that you want to offer through your name</li>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="important-box">
                    <img src="assets/images/EcomGeekz-Badges_Financial-Stability-.svg" alt="img" />
                    <h3>Financial stability</h3>
                    <p>Secure your financial future by reducing reliance on a single income source.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="important-box">
                    <img src="assets/images/EcomGeekz-Badges_Economic-Uncertainty.svg" alt="img" />
                    <h3>Economic uncertainty</h3>
                    <p>Mitigate economic uncertainties by spreading income across diverse channels.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="important-box">
                    <img src="assets/images/EcomGeekz-Badges_Growth-Opportunities.svg" alt="img" />
                    <h3>Growth opportunities</h3>
                    <p>Unlock new growth opportunities and expand your financial horizons.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="important-box">
                    <img src="assets/images/EcomGeekz-Badges_Adaptation-to-Market-Changes.svg" alt="img" />
                    <h3>Adaptation to market changes</h3>
                    <p>Stay resilient by adapting to shifting market conditions.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="important-box">
                    <img src="assets/images/EcomGeekz-Badges_Entrepreneurial-Edge.svg" alt="img" />
                    <h3>Entrepreneurial edge</h3>
                    <p>Gain a competitive edge by exploring various income streams.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="important-box">
                    <img src="assets/images/EcomGeekz-Badges_Sustainable-Wealth.svg" alt="img" />
                    <h3>Sustainable wealth</h3>
                    <p>Build sustainable wealth through smart income diversification strategies.</p>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="add-box">
                    ...
                    <ul class="bottol-list">
                        ...
                        <li>Get personalized 1-on-1 digital consultancy.</li>
                        <li>Gain insights into various revenue streams.</li>
                        <li>Get assistance with branding and marketing.</li>
                        <li>Launch new ventures with confidence.</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-6">
...
<!-- common-sec -->
<section class="common-sec padd-tb">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 my-auto">
...
<!-- ready-sec -->
<section class="ready-sec padd-tb">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
...
<section class="faq-sec padd-tb">
  ...
  <div class="accordion-item">
    ...
    <div id="collapsesix" class="accordion-collapse collapse" aria-labelledby="headingsix" data-bs-parent="#accordionExample">
      <div class="accordion-body">
       <p>You can schedule a consultation by visiting our contact page or reaching out via email or phone.</p>
      </div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div id="collapsnine" class="accordion-collapse collapse" aria-labelledby="headingnine" data-bs-parent="#accordionExample">
      <div class="accordion-body">
       <p>Results vary based on your goals and industry, but many clients experience positive outcomes within a few months.</p>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="headingten" class="accordion-collapse collapse" aria-labelledby="headingten" data-bs-parent="#accordionExample">
      <div class="accordion-body">
       <p>Yes, we provide ongoing support to help you adapt and grow as your business evolves.</p>
      </div>
    </div>
  </div>
        ...
        <div class="row mt-5">
            <div class="col-lg-4 col-md-6">
                <div class="customer-box box-col-1">
                    ...
                    <p><b>The support from the strategist created a seamless experience.</b> I got excellent advice along the way and received outstanding customer service.</p>
                    <p class="mt-3">—Maria C.</p>
                    <div class="d-flex">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="customer-box box-col-3">
                    <i class="fas fa-quote-left"></i>
                    <p>My strategist … was so helpful in explaining the process, what to expect, and when we'd move on to the next steps. <b> Amazing. I highly recommend this service!</b></p>
                    <p class="mt-3">—Andrea S.</p>
                    <div class="d-flex">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
