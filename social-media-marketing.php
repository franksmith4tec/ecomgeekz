...
<body class="hompg inner-main smm-page">
...
<section class="banner-main-sec">
    <img src="assets/images/smm-banner-bg.jpg" class="banne-img" alt="img" />
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <ul class="list-page">
                    ...
                    <li><a href="amazon-fba-automation.php" class="active">Social Media Marketing</a></li>
                </ul>
                <h1>Fuel Your Social Media Growth</h1>
                <p>Kickstart your brand’s success with expert social media marketing strategies. </p>
                <h6><b>We make it simple to grow and scale, helping you achieve a minimum of $10,000+ in monthly profits while strengthening your online presence.</b></h6>
            ...
            <div class="col-lg-6">
                <div class="ban-imgwrp">
                    <img src="assets/images/womans.png" alt="img"  class="mt-3" />
                </div>
                <div class="parallax-wrap">
                    <img class="stats-animate stats-1"  value="-1" src="assets/images/P-1.png" alt="img"  class="mt-3" />
                    <img class="stats-animate stats-2"  value="1" src="assets/images/P-2.png" alt="img"  class="mt-3" />
                    <img class="stats-animate stats-3" value="-2" src="assets/images/Facebook.png" alt="img"  class="mt-3" />
                    <img class="stats-animate stats-4" value="-2" src="assets/images/Instagram.png" alt="img"  class="mt-3" />
                </div>
            </div>
        </div>
    </div>
...
<section class="register-sec padd-tb">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <h2>EcomGeekz's Unbeatable Approach to Drive Your Success</h2>
                <p>At EcomGeekz, we specialize in launching and scaling marketing agencies with precision and excellence. Our unbeatable approach merges data-driven insights with tailored strategies, guiding your agency toward monthly revenues of up to $10,000.</p>
            </div>
            <div class="col-lg-4">
    ...
    <a href="javascript:;" onclick="setButtonURL();">
            ...
            <div class="col-lg-4">
                <div class="register-box">
                    ...
                    <p>We harness data to uncover untapped opportunities, building a sustainable and profitable business for you.</p>
                </div>
            </div>
              ...
              <div class="col-lg-4">
                <div class="register-box">
                    ...
                    <p>We customize strategies to meet the specific needs and goals of your business, ensuring maximum alignment with your audience.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="register-box">
                    ...
                    <p>After handover, we don’t stop at launch. Our team continually refines strategies to guarantee long-term success.</p>
                </div>
            </div>
                ...
                <div class="pack-box">
                    ...
                    <div class="pack-inner">
                        ...
                        <ul>
                            ...
                            <a href="application.php" class="themes-btn">Get started</a>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="pack-box">
                    <div class="pack-top-box midel">
                        <ul>
                            <li><img src="assets/images/pcack-img.png" alt="img" /></li>
                            <li>
                    ...
                    <div class="pack-inner">
                        ...
                        <ul>
                            ...
                            <a href="at-appointment.php" class="themes-btn">Get started</a>
                        </ul>
                    </div>
                </div>
            </div>
...
<section class="step-sec padd-tb">
    <div class="container">
        <div class="row testament">
           <div class="col-lg-6">
               <h2>Our Process for Building a Social Media Marketing Strategy</h2>
               <h3><img src="assets/images/Set-Up-Your-Business.svg" alt="img" class="img-size">Set Up Your Presence</h3>
               <p>We help establish your business profiles across all major social platforms, ensuring they are optimized for brand visibility and engagement from the start. </p>
               <h3><img src="assets/images/Create-Amazon-Store.svg" alt="img" class="img-size"> Develop Your Campaigns</h3>
               <p>Our team designs customized social media campaigns, creating engaging content and targeted ads to drive traffic and grow your audience.</p>
               <h3><img src="assets/images/Manage-Your-Store.svg" alt="img" class="img-size"> Manage Your Platforms</h3>
               <p>We handle the daily management of your social media accounts, overseeing post schedules, engagement, and community interaction to keep your brand active and responsive.</p>
               <h3><img src="assets/images/Increase-Sales.svg" alt="img" class="img-size"> Increase Conversions</h3>
               <p>Using competitor analysis and data insights, we optimize your ads and posts to increase engagement, drive conversions, and achieve 15-25% return on investment.</p>
      ...
      <div class="row testwraper">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-lg-6">
                  <img src="assets/images/smm-cta.jpg" alt="img" />
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 offset-lg-1">
                ...
                <p>EcomGeekz pioneers a transformative online business program, setting benchmarks in the industry. Our mission is to foster and elevate the next generation of agencies.</p>
                
                <p> We challenge outdated business practices, aiming to triple your revenue. Whether you're a novice or seasoned entrepreneur, our proven formula ensures profitable growth. We empower 5-figure agencies to scale effortlessly into 6 and 7-figures.</p>
                ...
                <p>At EcomGeekz, we enhance your operational efficiency to drive sales growth. Whether you operate with FBA, FBM, or PL, our Amazon seller specialists manage listings, orders, product sourcing, and inventory. With state-of-the-art automation tools, your store operates seamlessly round the clock, ensuring continuous performance.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="important-box">
                    ...
                    <p>We streamline stock levels, minimize overstocking, and ensure timely replenishments to meet demand, ultimately boosting profitability and customer satisfaction.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="important-box">
                    ...
                    <p>Our method employs discreet packaging and valid tracking, ensuring compliance and security. We meticulously monitor inventory and pricing, mitigating risks and maximizing cost-efficiency.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="important-box">
                    ...
                    <p>Experience faster transactions, improved operational efficiency, and heightened customer satisfaction. Trust us to optimize your store operations effortlessly for increased sales and success.</p>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                ...
                <!--      <input type="hidden" id="location" name="locationURL" value="http://ecomgeekz.com/social-media-marketing" />-->
                <!--        </div>-->
                <!--    </div>-->
                <!--</form>-->
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
                    ...
                    <p>Our Amazon store experts vigilantly monitor stock levels and pricing across your inventory using advanced Amazon automation tools.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
                    ...
                    <p>Our dedicated team and automated system promptly process new orders, ensuring efficient fulfillment by promptly notifying suppliers.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
                    ...
                    <p>Our team monitors the store account for issues such as policy violations and A-Z claims to maintain its health.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
                    ...
                    <p>We provide comprehensive customer support via email, phone, and our CRM system, resolving issues promptly to ensure customer satisfaction.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="reserve-box">
                    ...
                    <p>We collaborate with you over time to strategize and scale your Amazon seller account continuously, aiming for sustained growth and expansion.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="faq-sec padd-tb">
  ...
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body">
         <p>Amazon automation services manage all aspects of your Amazon store, including product sourcing, listings, inventory management, order processing, customer service, and returns. EcomGeekz utilizes proprietary automation tools to efficiently scale your business while maximizing profitability.</p>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div class="accordion-body">
         <p>We are a dedicated team of ecommerce experts committed to growing your business through advanced automation strategies. With a one-time fee and no hefty upfront costs, your success is our priority.</p>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      <div class="accordion-body">
         <p>Getting started is simple. Contact us to discuss your SKUs and inventory needs, receive a tailored quote, and connect with our dedicated account managers. No automated responses; we handle everything from listings to order fulfillment. Schedule a call today to begin.</p>
      </div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour" data-bs-parent="#accordionExample">
      <div class="accordion-body">
         <p>Yes, legitimate Amazon automation agencies adhere to Amazon’s strict guidelines. Beware of providers promising unrealistic outcomes. EcomGeekz ensures compliance with Amazon policies while delivering top-notch services.</p>
      </div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div id="collapsefive" class="accordion-collapse collapse" aria-labelledby="headingfive" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <p>There are no hidden fees with EcomGeekz. We believe in transparency and provide clear, upfront costs for all our services, ensuring you always know what you're paying for.</p>
      </div>
    </div>
  </div>
