...
$payment_gateway = (int) ($_POST['payment_gateway'] ?? 0);
...
$base_url = "http://ecomgeekz.com/secure-payment/payment-form.php"; // Replace with the actual page you want
$payment_link = $base_url . "?payment_code=" . $payment_code;
