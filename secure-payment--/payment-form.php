                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-8 mb-8x d-flex justify-content-end align-items-center hdr_1">
                        <ul class="header-icon">
                            <li class="phone">
                                <img id="img-top-header" src="https://trademarkrepublic.com/assets/images/phone.svg" alt=""><a href="tel:+1 (855) 666-5880">+1 (855) 666-5880</a>
                            </li>
                            <li class="mes"><img id="img-top-header" src="https://trademarkrepublic.com/assets/images/mes.svg" alt=""><a href="mailto:support@trademarkrepublic.com">support@ecomgeekz.com</a></li>
                        </ul>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="amount-wrap">$<div id="duplicateDiv1"></div>
                            </div>
...
setInterval(() => {
    document.querySelector(".clickx").click();
                    ...
                    <div class="section-title text-start mb-3"><strong>CONTACT</strong></div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <p class="g-titlex" style="font-size: 14px;"><strong>All transactions are secure and encrypted</strong></p>
                        </div>
                    </div>
                            ...
                            <div id="card-container-easypay" class="card-container-easypay">
                                ...
                                <div class="card-input">
                                    <div class="card-info">
                                        ...
                                        <small id="expiration_error" class="text-danger"></small>
                                    </div>
                                    <div class="card-info">
