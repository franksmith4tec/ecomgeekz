...
<head>
    ...
    <title>EcomGeekz | Thank You</title>
...
<body>
    ...
    <div class="thank-you-container">
        ...
        <p class="thank-you-text">Payment Successful!</p>
        <p class="thank-you-description">Your payment has been processed successfully. You will receive a confirmation email shortly.</p>
